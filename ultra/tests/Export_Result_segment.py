...
def main(model_ckpt, input_base_dir):
    ...
    output_base_dir = '../Result/segment/predictions'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--model_ckpt", type=str, default="../output/runs/segment/segmentation_yolov11_s_sgd/weights/best.pt"   
    )
    parser.add_argument(
        "--input_base_dir", type=str, default="../../data/segmentation_coco/images/test"   
    )
